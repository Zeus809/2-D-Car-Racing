...
//    pos[0]= pos[0]*-1;
    ...
    switch(speeds[i])
    {
        ...
        case -3: glColor3f(0.1, 0.0, 0.1); break;
        case 5:
        case 6:
...
//	glRectf(-17, 0, -16, 2);
//	glRectf(-16, 0, -14, -2);
//	glRectf(-8, 3.5, -10, 4.5);
//
//	glColor3f(0.0, 0.75, 0.0);
//	glRectf(-10, -3.5, -12, 3.5);
////	glRectf(-16, 0, -14, -2);
////	glRectf(-8, 3.5, -10, 4.5);
...
void drawSurroundings()
{
    ...
    glRectd(-130, 160, -63, -160);

    glColor3f(0.0, 0.0, 0.0);
    glRectd(-130, 160, -240, -160);
    glRectd(135, -160, 240, 160);
}
...
void drawDistanceBar()
{
    ...
    int temp = (178-distance)*100/185;
    glTranslated(0, temp*3 , 0);
    glRectd(-145, -142, -140, -137);
//    glBegin(GL_LINE_LOOP);
//        glVertex2f(5, 90);
//        glVertex2f(5, -90);
//        glVertex2f(-5, -90);
